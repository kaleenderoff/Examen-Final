...
import proyectomundial.DAO.UsersDAO;
...
public class GUIManual extends JFrame {
    ...
    // Matriz que permite almacenar los usuarios en la base de datos
    ...
    private void initComponents() {
        ...
        // Pinta la opción de Menú de la sesion
        pintarMenuSesion();
    ...
    private void pintarMenuSesion() {
        ...
        jPanelMenuSesion.add(vacioSesion, BorderLayout.WEST);
    ...
    private void accionSesion() {
        String username = String.valueOf(JOptionPane.showInputDialog(null, "Usuario"));
        String password = String.valueOf(JOptionPane.showInputDialog(null, "Contraseña"));
        
        usuarios = usersDAO.getUsuariosMatriz();
        
        for (int i = 0; i < usuarios.length; i++) {
            if (usuarios[i][0].equals(username) && usuarios[i][1].equals(password)) {
                haySesion = true;
            }
        }
    ...
    public void pintarSesion() {
        ...
        JButton registrarme = new JButton();
        registrarme.setText("Registrame");
